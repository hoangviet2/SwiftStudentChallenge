...
struct MeetingTimerView: View {
    let speakers: [DiagnosticTimer.Speaker]
...
struct MeetingTimerView_Previews: PreviewProvider {
    static var speakers: [DiagnosticTimer.Speaker] {
        [DiagnosticTimer.Speaker(name: "Bill", isCompleted: true), DiagnosticTimer.Speaker(name: "Cathy", isCompleted: false)]
    }
